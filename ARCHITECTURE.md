...
**Skills library** (`framework/skills-library/`) — pre-built skills that can be copied into projects. Not included in the repo — you populate it yourself. See [`framework/skills-library/README.md`](framework/skills-library/README.md).
