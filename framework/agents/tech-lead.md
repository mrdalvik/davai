...
2. **AI-friendliness** — how well does {{ai_tool}} work with this? High = popular framework with extensive docs and examples in training data. Medium = well-known but smaller ecosystem. Low = niche, exotic, or very new. Prefer high.
