...
This directory contains pre-built AI developer skills that can be copied into projects by the AI HR agent.
...
During Phase 3 (Tools & Skills), the AI HR subagent scans this directory, reads each `SKILL.md`, and recommends relevant skills for the project. Selected skills are copied into the project's skills directory (path depends on the AI tool configured in `framework/config.yml`).
